...
{
    public class WayPointMove : Move
    {
        #region
        ...
        private void FixedUpdate()
        {
            switch (m_State)
            {
                ...
                case STATE.Walking:
                    LookAtDestination();
                    m_CharacterController.SimpleMove(MovingDirection() * m_WalkingSpeed * 50);
                    if (m_Animator == null) break;
                ...
                case STATE.Running:
                    LookAtDestination();
                    m_CharacterController.SimpleMove(MovingDirection() * m_RunningSpeed * 50);
                    if (m_Animator == null) break;
                    m_Animator.SetBool(m_WalkingAnimationName, false);
